...
function handlerSetup(config) {
    ...
    function newMessage() {
        ...
        var cleanedStack = build_stack_trace_1.buildStackTrace('');
        var em = new error_message_1.ErrorMessage().setServiceContext(config.getServiceContext().service, config.getServiceContext().version);
        em._autoGeneratedStackTrace =
            cleanedStack;
        return em;
    }
    return newMessage;
