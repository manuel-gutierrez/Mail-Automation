...
var expressRequestInformationExtractor = require("../request-extractors/express");
...
function restifyRequestFinishHandler(client, config, req, res) {
    ...
    if (res._body instanceof Error ||
        ...
        em = new error_message_1.ErrorMessage().consumeRequestInformation(
...
function serverErrorHandler(client, config, server) {
    server.on('uncaughtException', function (req, res, reqConfig, err) {
        var em = new error_message_1.ErrorMessage().consumeRequestInformation(expressRequestInformationExtractor.expressRequestInformationExtractor(req, res));
