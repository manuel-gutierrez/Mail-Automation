...
var express_1 = require("../request-extractors/express");
...
function makeExpressHandler(client, config) {
    ...
    function expressErrorHandler(err, req, res, next) {
        ...
        var em = new error_message_1.ErrorMessage()
            .consumeRequestInformation(express_1.expressRequestInformationExtractor(req, res))
